...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/wpkc0429/livebuy-ios-sdk/releases/download/v2.0.0-rc.5/LiveBuySDK.xcframework.zip",
            checksum: "58e6f51f51c844020f2ad03035531cb5bbfbe9ace200854676fdfbd273bf7f22"
        ),
