...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/ariesweng/livebuy-ios-sdk/releases/download/v4.2.0/LivebuySDK.xcframework.zip",
            checksum: "7aefa6a5ed7ac4d8eef6759eda8adc89a08b26c8955b9ff01c8649eac7c2e87c"
        ),
